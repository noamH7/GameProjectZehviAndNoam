...
document.getElementById("name1t").textContent = users[0].name;
document.getElementById("score1t").textContent = users[0].triviaScore;
document.getElementById("name2t").textContent = users[1].name;
document.getElementById("score2t").textContent = users[1].triviaScore;
document.getElementById("name3t").textContent = users[2].name;
document.getElementById("score3t").textContent = users[2].triviaScore;

users.sort((a, b) => a.snakeAndLedders > b.snakeAndLedders);
document.getElementById("name1lar").textContent = users[0].name;
document.getElementById("score1lar").textContent = users[0].snakeAndLedders;
...
document.getElementById("name3lar").textContent = users[2].name;
document.getElementById("score3lar").textContent = users[2].snakeAndLedders;
